    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme) {
            ...
            $theme->asset()->usePath()->add('index-spring', 'css/index.spring.css');
            $theme->asset()->usePath()->add('index-carousel', 'css/index.carousel.css');
            ...
            $theme->asset()->container('footer')->usePath()->add('script', 'js/script.js', ['datepicker-js']);
