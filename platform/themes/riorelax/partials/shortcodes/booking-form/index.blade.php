        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="contact-bg02">
                    ...
                    <form action="{{ route('public.booking') }}" method="post" class="contact-form mt-30">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="contact-field p-relative c-name mb-20">
                                    ...
                                    <input type="text" id="booking-form-start-date" autocomplete="off"
                                           ...
                                           data-start-date="{{ old('start_date', Carbon\Carbon::now()->format('d-m-Y')) }}"
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact-field p-relative c-subject mb-20">
                                    ...
                                    <input type="text" id="booking-form-end-date" autocomplete="off"
                                           ...
                                           data-start-date="{{ old('end_date', Carbon\Carbon::now()->addDay()->format('d-m-Y')) }}"
                                           data-date-format="dd-mm-yyyy"
                                           data-locale="{{ App::getLocale() }}"
                                           placeholder="{{ Carbon\Carbon::now()->addDay()->format('d-m-Y') }}"
                                           value="{{ old('end_date', Carbon\Carbon::now()->addDay()->format('d-m-Y')) }}"
                                           name="end_date">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="contact-field p-relative c-subject mb-20">
                                    ...
                                    <select name="adults" id="adults">
                                        @for($i = 1; $i <= 10; $i++)
                                            <option value="{{ $i }}" @selected(old('adults', 1) === 1)>{{ $i }} {{ $i == 1 ? __('Guest') : __('Guests') }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
