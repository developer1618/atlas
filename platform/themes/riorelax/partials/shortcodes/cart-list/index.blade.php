<h2 class="container m-auto text-white py-5">Main dishes</h2>
<div class="m-auto d-block d-lg-flex justify-content-between pb-5 position-static h-auto" style="height:auto;">
    ...
    <div class="fitcontent flex-column justify-content-between px-4 position-static">
        ...
        <div class="pb-4 pt-5">
            <button class="add-btn px-4 py-3 w-100 border-0 text-white fw-medium" onclick="modalOrderWindow()">Order
                <span id="totalFoodPrice" name="totalPrice"></span> smn</button>
        </div>
    </div>
</div>
<div class="backgroundModal">
    <div id="orderModal">
        <div id="form">
            ...
            <label for="lastName" class="mt-3">Surname</label>
            <input type="text" id="lastName">
            <label for="room" class="mt-3">Room number</label>
            <input type="number" id="room">
            <input type="submit" class="add-btn px-4 py-2 mt-5 w-100 border-0 text-white fw-medium"
                onclick="sendFormData()" value="Send">
        </div>
    </div>
    <div id="orderAccepted" class="text-center">
        <img src="http://atlashoteldushanbe.com/storage/atlas-logo.png" alt="Logo" class="mb-5">
        <h3 class="mb-2" style="color: #C09B5A;">Your order is accepted!</h3>
        <p class="mb-5">
            Your order has been successfully completed.
             <br>We will contact you shortly
             <br>to confirm the order
        </p>
        <a href="/" class="text-white mt-5"
            style="background-color: #C09B5A; hover:background-color: #C09B5A; padding: 16px 32px; margin-top: 16px;">Go back to the main page</a>
    </div>
</div>
        ...
        let basketItem = storageItem.map(item => {
            ...
            <div class="w-75">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-white">${item.foodPrice} smn</h6>
                    </div>
                    <div class="d-flex">
