        ...
        <div class="row flex-row-reverse justify-content-center align-items-center">
            ...
            <div class="col-xxl-5 col-xl-12 col-lg-12">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-lg-6 col-6 mt-15">
                                    <div class="form-group mb-25 text-end">
                                        <a class="font-xs color-grey-500"
                ...
                <div class="col-lg-12 mt-20">
                    ...
                    <a class="d-inline-block align-middle color-success ms-1 custom-register-label"
                        href="{{ route('customer.register') }}">{{ __('Sign up now') }}</a>
                </div>
            </div>
        </div>
    </div>
