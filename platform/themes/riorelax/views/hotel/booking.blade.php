@if (is_plugin_active('payment'))
    ...
    @php
        Theme::asset()->container('footer')->add('payment-js', 'vendor/core/plugins/payment/js/payment.js')
    @endphp
                ...
                <form action="{{ route('public.booking.checkout') }}" class="booking-form-main payment-checkout-form mb-50 shadow-block" method="POST">
                    ...
                    <div class="room-booking-form p-0">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-20">
                                    <label for="txt-first-name">{{ __('First Name') }} <span class="required" style="color:#C09B5A">*</span></label>
                                    <input type="text" name="first_name" id="txt-first-name" class="form-control" required value="{{ old('first_name', $customer) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-20">
                                    <label for="txt-last-name">{{ __('Last Name') }} <span class="required" style="color:#C09B5A">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-20">
                                    <label for="txt-email">{{ __('Email') }} <span class="required" style="color:#C09B5A">*</span></label>
                                    <input type="email" name="email" id="txt-email" class="form-control" required value="{{ old('email', $customer) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-20">
                                    <label for="txt-phone">{{ __('Phone') }} <span class="required" style="color:#C09B5A">*</span></label>
                                    <input type="number" name="phone" id="txt-phone" class="form-control" required value="{{ old('phone', $customer) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-20">
                                    <label for="txt-country">{{ __('Country') }} <span class="required" style="color:#C09B5A">*</span></label>
                                    <input type="text" name="country" id="txt-country" class="form-control" required value="{{ old('country', $customer) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group mb-20 custom-checkbox d-block">
                            <label for="terms_conditions" class="w-100">
                                <input type="checkbox" id="terms_conditions" name="terms_conditions" required value="1" @if (old('terms_conditions') == 1) checked @endif> {{ __('Terms & conditions *') }}
                                <span></span>
                            </label>
                        </div>
                ...
                <aside>
                    ...
                    <div class="form-information">
                        ...
                        <div>
                            ...
                            <p>{{ __('Bonus') }}: <span id="totalBonus">{{ $amount * 0.05 ?? 0}} </span><img src="http://atlashoteldushanbe.com/storage/bonus.png" alt="Bonus" style="width: 16px; padding-bottom: 3px;"></p>
